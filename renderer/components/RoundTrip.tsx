  ...
  FlightsData.map((Flight) => {
    Flight.buckets.map((buckets) =>{
      buckets.items.map((items) =>{
        items.legs.map((legs) =>{
          comname.push({name : legs.carriers.marketing[0].name, isChecked:true});
        })
      })
    })
  })
                  ...
                  <div className="row" key={key} id={bucket.id}>
                      {
                        bucket.items.map((items, key) =>(
                          <>
                          {
                            ...
                            {airline.name == items.legs[0].carriers.marketing[0].name || airline.name == items.legs[1].carriers.marketing[0].name ? (<>
                              <div className="card border shadow-5 bg-light w-100 mb-2">
                                <div className="row">
                                  <div className="col-2 border-end">
                                    ...
                                    <div className="row">
                                      <div className="col-12 mt-4 d-flex align-items-center justify-content-center">
                                        <img className="shadow-2-strong carriers mt-1" src={items.legs[1].carriers.marketing[0].logoUrl} alt={items.legs[1].carriers.marketing[0].name} />
                                      </div>
                                      <div className="col-12 d-flex align-items-center justify-content-center">
                                        <h6 className='airname'>{items.legs[1].carriers.marketing[0].name}</h6>
                                      </div>
                                    </div>
                                  </div>
                                  <div className="col-7  border-end ">
                                    <div className="row">
                                      <div className="col-12"><span className="text-primary">Round Trip flights</span></div>
                                    ...
                                    <div className="row">
                                      <div className="col-12 d-flex justify-content-between">
                                          <div className="text-success"><strong>{items.legs[1].origin.name + ' (' + items.legs[1].origin.id + ')'}</strong></div>
                                          <div><FaArrowRight/></div>
                                          <div  className="text-success"><strong>{items.legs[1].destination.name + ' (' + items.legs[1].destination.id + ')'}</strong></div>
                                      </div>
                                      <div className="col-12">
                                        <div className="row">
                                          <div className="col-6">
                                            ...
                                            <div className="desinfo  text-start">
                                              <h6>Take off</h6>
                                              <span className="timeSho">{ timeSho(items.legs[1].departure)}</span>
                                            </div>
                                          </div>
                                          <div className="col-6 flat-right">
                                            <div className="desinfo text-end">
                                              <h6>Landing</h6>
                                              <span className="timeSho">{ timeSho(items.legs[1].arrival)}</span>
                                            </div>
                                            <div className="desicon text-end">
                                              <FaPlaneArrival className="text-danger"/>
                                            </div>
                                      ...
                                      <div className="col-12">
                                        <p>Flight Duration {time_convert(items.legs[1].durationInMinutes)} </p>
                                      </div>
                                    </div>
                                  </div>
                                  <div className="col-3">
                                    <div className="row p-5 d-flex justify-content-center">
                                      <div className="mt-5 d-flex align-items-center justify-content-center"><h5>{items.price.formatted}</h5></div>
                                      <div className="d-flex align-items-center justify-content-center"><button  className="btn btn-primary">Book Now</button></div>
                                    </div>
                                  </div>
                                </div>
                              </div>
