...
import SkeleLoadr from '../components/SkeleLoadr'
...
const round = () =>  {
  ...
  return (
    <React.Fragment>
      <Layout>
        <Head>
          <title>Round Trip - FlightPlan </title>
        </Head>
        <div className="row">
          <div className="col-12">
            <div className="card">
                <div className="col-12">
                  <h2 className="btn btn-primary titelFl">Round Trip</h2>
                </div>
              ...
              </>):(<>
              {
                FlightsData[0].Flights.context == undefined ? (<></>):(<>
                {
                  ...
                  FlightsData[0].Flights.context.totalResults == 0 ? (
                    ...
                    <>
                    <RoundTrip Flights={FlightsData[0]} />
                    </>
                    )
